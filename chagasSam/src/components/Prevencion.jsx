  ...
  return (
    <>
      ...
      <section className="mt-12">
        <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl shadow-md p-6">
          <h3 className="text-xl font-bold text-[#E85D04] mb-4 text-center">
            Día Mundial de la Enfermedad de Chagas 2025 - Mensaje del Dr. Tedros Adhanom Ghebreyesus, Director General de la OMS
          </h3>
          <div className="aspect-video w-full rounded-lg overflow-hidden">
            <iframe
              className="w-full h-full"
              src="https://www.youtube-nocookie.com/embed/cdAfZJsrXvE"
              title="Día Mundial de la Enfermedad de Chagas 2025"
